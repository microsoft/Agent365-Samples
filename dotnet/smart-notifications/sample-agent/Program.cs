...
using Agent365TaskPersonalizationSampleAgent.Agents;
using Agent365TaskPersonalizationSampleAgent.Extensions;
using Agent365TaskPersonalizationSampleAgent.telemetry;
...
{
    app.MapGet("/", () => "Agent 365 Task Personalization Agent (Semantic Kernel)");
