...
object ID, or agent-user ID. An administrator must already have authorized the
instance's OBS **application roles**; delegated consent is insufficient. This sample
does not provision identities or grant permissions.
...
check the configured IDs, blueprint credential and OBS application role consent.
