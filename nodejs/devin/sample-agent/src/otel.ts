...
import { ClusterCategory, RuntimeConfiguration } from "@microsoft/agents-a365-runtime";
...
const observability = ObservabilityManager.configure((builder) => {
  ...
  builder
    ...
    .withClusterCategory((process.env["CLUSTER_CATEGORY"] as ClusterCategory) || ClusterCategory.dev)
